...
class TestLoginRegisterScenario:
    ...
    def test_negative_phone_format(self, driver):
        ...
        negative_phone_format.execute_phone_format("03922226")
        ...
        # Reset all
        negative_phone_format.reset_all()
    ...
    def test_negative_phone_invalid(self, driver, phone, error_message):
        ...
        negative_phone_invalid.execute_phone_invalid(phone)
        ...
        #Reset all
        negative_phone_invalid.reset_all()
    ...
    def test_negative_uncheck_terms(self, driver):
        ...
        #Type phone, checked term & policy
        negative_uncheck_term.execute_phone_valid("0856461679")
        ...
        negative_uncheck_term.uncheck_terms()
    ...
    def test_positive_register(self, driver):
        ...
        # Type phone, checked term & policy, click next button
        positive_register.execute_sign_in("0396565656")
